...
$CollegeEducationSocialIcon = array();
  for($i=1;$i <= 5;$i++):  
    $CollegeEducationSocialIcon[] =  array( 'slug'=>sprintf('CollegeEducationSocialIcon%d',$i),   
      'default' => '',   
      'label' =>  sprintf(/* translators: %s social account name */ esc_html__( 'Social Account %s', 'college-education' ),$i),   
  ...
  for($i=1;$i <= 5;$i++):  
    $CollegeEducationSocialIconLink[] =  array( 'slug'=>sprintf('CollegeEducationSocialIconLink%d',$i),   
      'default' => '',   
      'label' => sprintf( /* translators: %s social account link */ esc_html__('Social Link %s', 'college-education' ),$i),   
      'priority' => sprintf('%d',$i) );  
  endfor;
